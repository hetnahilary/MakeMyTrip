...
public class MyTrip {
  ...
  public void Trip() throws InterruptedException {
		...
		username.clear();
		username.sendKeys("hetnahilary13@gmail.com");
		...
		driver.findElement(By.id("fName")).sendKeys("Hetna");
		driver.findElement(By.id("lName")).sendKeys("Hilary");
		Thread.sleep(3000);
		...
		Thread.sleep(3000);
		driver.findElement(By.id("PAYMENT_cardNumber")).sendKeys("123476789012345");
		driver.findElement(By.id("PAYMENT_nameOnCard")).sendKeys("Hetna Hilary");
		Thread.sleep(2000);
		...
		Thread.sleep(1000);
		driver.findElement(By.id("PAYMENT_billingAddress")).sendKeys("PALLITHURA");
		driver.findElement(By.id("PAYMENT_billingCity")).sendKeys("TVM");
		driver.findElement(By.id("PAYMENT_billingPin")).sendKeys("695582");
